#dividing airbnb in Ottawa based on the location of a handyman shop
...
df = pd.read_csv(
    r'/home/agnieszka/Pobrane/Airbnb+listings+in+Ottawa+(May+2016) (1)/Airbnb listings in Ottawa (May 2016).csv')
df.shape
df.head()
